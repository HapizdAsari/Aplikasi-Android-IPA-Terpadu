...
import com.example.ipaterpadu.MainAdapter.MainViewHolder
import com.bumptech.glide.Glide
import com.bumptech.glide.load.engine.DiskCacheStrategy
import com.bumptech.glide.load.resource.bitmap.CenterCrop
import com.bumptech.glide.load.resource.bitmap.RoundedCorners
import com.example.ipaterpadu.detail.DetailActivity
...
class MainAdapter(
    ...
    override fun onBindViewHolder(holder: MainViewHolder, position: Int) {
        ...
        Glide.with(context)
            ...
            .into(holder.imageMateri)

        holder.cvListMain.setOnClickListener {
            val intent = Intent(context, DetailActivity::class.java)
            intent.putExtra(DetailActivity.DETAIL_MATERI, modelMainList[position])
    ...
    class MainViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            ...
            imageMateri = itemView.imagePahlawan
        }
    }
